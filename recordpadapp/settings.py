"""
Django settings for recordpadapp project.
...
SECRET_KEY = '%-+u($)=+-*rfbnik204xsy_4==d1=40lc6u7#xsv%nab75s6x'
...
ROOT_URLCONF = 'recordpadapp.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['templates','staic',],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'recordpadapp.wsgi.application'
